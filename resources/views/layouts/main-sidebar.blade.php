...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="side-item side-item-category"><strong>التقارير</strong></li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                    ...
                    </svg><span class="side-menu__label"><strong>التقارير</strong></span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'cards')) }}"> <strong>تقارير
                                الفواتير</strong></a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'darggablecards')) }}"> <strong>تقارير
                                العملاء</strong></a>
                    </li>
                </ul>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label"><strong>المستخدمين</strong></span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'mail')) }}"><strong>قائمة
                                المستخدمين</strong></a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'mail-compose')) }}"> <strong>صلاحيات
                                المستخدمين</strong></a>
                    </li>
                </ul>
            </li>
